          ...
          <div className="contact-content">
            <div className="contact-info">
              <div className="contact-item">
                <h3>📍 Address</h3>
                <p>5, Gulshan Apartment, Dixit Road, Vile Parle(East), Mumbai-400057</p>
              </div>
              <div className="contact-item">
                <h3>📞 Phone</h3>
                <p>+91 83558 88976</p>
              ...
              <div className="contact-item">
                <h3>
                  <svg className="instagram-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                ...
                <p><a href="https://www.instagram.com/highend_interiors9" target="_blank" rel="noopener noreferrer">highend_interiors9</a></p>
              </div>
            </div>
